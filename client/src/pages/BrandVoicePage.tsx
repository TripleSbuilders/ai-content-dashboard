...
export default function BrandVoicePage() {
  ...
  return (
    <>
        ...
        <section className="glass-panel rounded-3xl border border-outline-variant/25 p-8">
          ...
          <ul className="space-y-4 text-sm text-on-surface-variant">
            {loading ? (
              ...
              pillars.map((p, i) => (
                <li key={i} className="rounded-xl bg-surface-container-low/40 p-3">
                  ...
                  <input
                    ...
                    className="mb-2 mt-1 w-full rounded-lg border border-outline-variant/30 bg-surface-container-lowest px-3 py-2 text-on-surface focus:ring-2 focus:ring-primary/35"
                  />
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="mt-1 w-full rounded-lg border border-outline-variant/30 bg-surface-container-lowest px-3 py-2 text-on-surface focus:ring-2 focus:ring-primary/35"
                  />
                </li>
              ))
            )}
        ...
        <section className="glass-panel rounded-3xl border border-outline-variant/25 p-8">
          ...
          >
            <input
              ...
              className="flex-1 rounded-xl border border-outline-variant/30 bg-surface-container-lowest px-3 py-2 text-sm text-on-surface focus:ring-2 focus:ring-primary/35"
            />
            <button type="submit" className="rounded-xl bg-primary px-4 py-2 text-sm font-bold text-on-primary">
              Add
            </button>
          </form>
      ...
      <section className="mt-8 glass-panel rounded-3xl border border-primary/20 p-8">
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-xl border border-outline-variant/30 bg-surface-container-lowest px-4 py-3 font-manrope text-on-surface italic focus:ring-2 focus:ring-primary/35"
        />
        <button
          type="button"
